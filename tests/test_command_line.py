...
rsa2048_pub_pkcs8 = (
    "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA1xz7"
...
rsa2048_pub = (
    "MIIBCgKCAQEA1xz7YS11AbUqC8otGgQ11LUaMNlzl7AStt"
...
nist256_pub_pkcs8 = (
    "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAE0tN9OH6PZ"
    + "vKPI59DNKe1LX+MeNpPY8Jfv88PefDixh02YNvcp8hHE7"
    + "HhOZxiT7pRsTmrbp8PUbe0bO+ZsKyNSQ=="
)

nist256_pub = (
    "BNLTfTh+j2byjyOfQzSntS1/jHjaT2PCX7/PD3nw4sYdNmDb3K"
    + "fIRxOx4TmcYk+6UbE5q26fD1G3tGzvmbCsjUk="
)

nist256_priv = (
    "MHcCAQEEIB4NWQ42ppxbEfSo1GtuLPxJVLDOpQ2lLAzxjlvG"
...
class KeyManTestCase(unittest.TestCase):
    def test_00_util(self):
        self.assertEqual(
            rsa2048_pub, command_line.pkcs8_to_pub(rsa2048_pub_pkcs8)
        )
        self.assertEqual(
            nist256_pub, command_line.pkcs8_to_pub(nist256_pub_pkcs8)
        )
    ...
    @patch("aedkeyman.aed.ArborEdgeDefense.list_keys")
    @patch("os.getenv")
    def test_15_sync_one_out_of_two(
        self,
        getenv,
        aed_list_keys,
        aed_import_key,
        ...
        aed_import_key.side_effect = [{"label": "nist256", "type": "EC"}]
        command_line.cmd_skey_sync_keys(args)
