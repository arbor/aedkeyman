...
class ArborEdgeDefenseTestCase(unittest.TestCase):
    ...
    def test_00_import_rsa_key_success(self, mpost):
        ...
        aed = aedkeyman.ArborEdgeDefense(
            AED_HOST, AED_TOKEN, creds, use_hsm=True
        )
        expected_rdata = {"label": "newrsa", "type": "RSA"}
        mresp = MagicMock()
        ...
        mpost.assert_called_with(
            url=BASE_URL + "v2/hsm/certificates/",
            headers=HEADERS,
            json=body,
            verify=True,
        )
    ...
    def test_import_rsa_key_fail(self, mpost):
        ...
        expected_rdata = {
            "errors": [
                {"code": "hsmError", "message": "Certificate parse error"}
            ],
            "message": "HSM Error",
        }
        mresp = MagicMock()
        ...
        server_resp_data = [
            {
                "label": "firstec",
                "public": (
                    "BF7PXST4hfxGVy9z9Pvro/HibHa72hbqrbvovk/ht4DTX7"
            ...
            },
            {
                "label": "ecdirect",
                "public": (
                    "BGcIUz8K9MyRDkfV73aS0D0xRuiOxrqtUk2NREQeT+KgMU/"
            ...
            },
            {
                ...
                "public": (
                    "MIIBCgKCAQEAs/X8vDUD2xBI0PkksK48GsOTmApV9fJ7h8"
    ...
    def test_delete_key_success(self, mdel):
        ...
        mdel.assert_called_with(
            url=BASE_URL + "v2/hsm/certificates/newrsa",
            headers=HEADERS,
            verify=True,
        )
    ...
    def test_delete_key_fail(self, mdel):
        ...
        mdel.assert_called_with(
            url=BASE_URL + "v2/hsm/certificates/test",
            headers=HEADERS,
            verify=True,
        )
